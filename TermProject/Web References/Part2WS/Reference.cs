...
namespace TermProject.Part2WS {
    ...
    public partial class Part2WS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void addAnswerAsync(string email, string answer, int ID, int verification) {
            this.addAnswerAsync(email, answer, ID, verification, null);
        }
        
        /// <remarks/>
        public void addAnswerAsync(string email, string answer, int ID, int verification, object userState) {
        ...
        /// <remarks/>
        public void updateNameAsync(int accountID, string newName, int verification) {
            this.updateNameAsync(accountID, newName, verification, null);
        }
        
        /// <remarks/>
        public void updateNameAsync(int accountID, string newName, int verification, object userState) {
            ...
            this.InvokeAsync("updateName", new object[] {
                        accountID,
                        newName,
                        verification}, this.updateNameOperationCompleted, userState);
        }
