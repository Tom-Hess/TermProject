<%@ Page Title="" Language="C#" MasterPageFile="~/login.Master" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="TermProject.WebForm3" %>
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <br />
                    <h3 class="panel-title"><strong>Cloud Administrator Login</strong></h3>
                </div>
